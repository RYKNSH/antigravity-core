...
2.  **SSD への自動配備 (Deployment)**: ビルド完了後、成果物（`.app` および `.dmg`）を SSD のルート直下 (`$HOME/.antigravity/_builds/`) に自動コピー。
...
- **場所**: `$HOME/.antigravity/_builds/portable-studio.app`
...
- **場所**: `$HOME/.antigravity/_builds/portable-studio_0.1.0_aarch64.dmg`
