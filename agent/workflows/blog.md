...
**Scripts**: `auth_notion.js`, `session_state.js`, `generate_social_assets.js`, `ffmpeg_cli.js`, `remotion_cli.js`, `whisper_cli.js`, `image_cli.js`, `penpot_cli.js`, `everwebinar_cli.js`
**Skills**: `frontend-design`
**Knowledge**: `social_knowledge`, `soloprostudio_social_knowledge_ecosystem`, `artistory_studio`, `portable_studio_app`, `video_editing_pipeline_videdit`, `gws_google_workspace_cli.md`, `discord_buddy_ecosystem`
